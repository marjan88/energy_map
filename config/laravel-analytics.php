...
return
    ...
    [
         ...
         */
        'clientId' => env('829907269977-qp8fiibfo44hc6qrepnreuh4c7fv5e4d.apps.googleusercontent.com'),
         ...
         */
        'serviceEmail' => env('829907269977-qp8fiibfo44hc6qrepnreuh4c7fv5e4d@developer.gserviceaccount.com'),

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('laravel-analytics/energien-plant-app-b9c35821272a.p12'),
